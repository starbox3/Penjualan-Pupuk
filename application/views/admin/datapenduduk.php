    ...
    <div class="container-fluid">
        ...
        <div class="card card-info card-outline">
            <div class="card-body">
                ...
                ?>
                <form action="<?= base_url('admin/deleteAllPenduduk') ?>" method="POST">
                    <div class="col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-1 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?= site_url('admin/viewData?data=' . $data['nik']) ?>" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>
                                            <a href="<?= site_url('admin/editPenduduk?data=' . $data['nik']) ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <?= form_open_multipart('admin/dataPenduduk'); ?>
                <div class="row">
                    <div class="col-sm-4">
