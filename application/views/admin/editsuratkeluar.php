        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info card-outline">
                    ...
                    <?= form_open_multipart('admin/updateSuratKeluar?surat=' . $surat['no_agenda']); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="nik" class="form-control select2bs4" style="width: 100%;">
                                        <option value="" disabled>--Cari NIK--</option>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="suratmasuk" class="form-control select2bs4" style="width: 100%;">
                                        <option value="" disabled selected>--Cari Nomor Surat--</option>
                                        <?php foreach ($SM as $masuk) : ?>
                                            <option value="<?= $masuk['nomor_surat']; ?>" <?= $surat['nomor_surat_masuk'] == $masuk['nomor_surat'] ? 'selected' : null; ?>><?= $masuk['nomor_surat']; ?> </option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><i class="fas fa-envelope"></i> Nomor Surat Keluar</label>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tujuanSurat" placeholder="Tujuan Surat" value="<?= $surat['tujuan_surat'] ?>" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" name="tanggalSurat" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Tanggal Surat" value="<?= $surat['tanggal_surat'] ?>" />
                    ...
                    <div class="modal-footer justify-content-between">
                        <a href="<?= site_url('admin/SuratKeluar') ?>" class="btn btn-info ">Batal</a>
