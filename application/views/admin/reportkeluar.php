...
$query = "SELECT * FROM `tbl_surat_keluar` WHERE `tanggal_surat` >= '$awal' AND `tanggal_surat` <= '$akhir' ORDER BY `no_agenda` DESC";
...
<body>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td align="center">
                <p style="font-family:coopbl;font-size:15pt;"><strong>LAPORAN AGENDA SURAT KELUAR</strong></p>
    ...
    <table align="center" width="100%" border="1px" style="margin-bottom: 30px;">
        <tr class="garis_tr">
            ...
            <th class="garis_td">Nomor Surat Masuk</th>
        </tr>
        <?php foreach ($datasurat as $data) : ?>
            <tr class="garis_tr">
                ...
                <td class="garis_td" align="center"><?= $data['nomor_surat_masuk']; ?></td>
            </tr>
        <?php endforeach; ?>
    </table>
