    ...
    <div class="container-fluid">
        <div class="card card-info card-outline">
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/deleteAllSuratKeluar') ?>" method="POST">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-warning btn-sm mb-1" data-toggle="modal" data-target="#addSurat"><i class="fas fa-plus"></i> Tambah Surat Keluar
                        </button>
                        <button type="submit" class="btn btn-danger btn-sm mb-1" name="deleteselect"><i class="fas fa-trash"></i> Hapus Surat Keluar</button>
                            ...
                            <?php foreach ($surat as $data) : ?>
                                <tr>
                                    ...
                                    <td class="text-center py-1 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?= site_url('admin/editSuratKeluar?surat=' . $data['no_agenda']) ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <?= form_open_multipart('admin/addSuratKeluar'); ?>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label><i class="fas fa-envelope"></i> Nomor Dari Surat Masuk</label>
                            <select name="suratmasuk" class="form-control select2bs4" style="width: 100%;" required>
                                <option value="" disabled selected>--Cari Nomor Surat--</option>
                                <?php foreach ($SM as $masuk) : ?>
                                    <option value="<?= $masuk['nomor_surat']; ?>"><?= $masuk['nomor_surat']; ?> </option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label><i class="fas fa-envelope"></i> Nomor Surat</label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label><i class="fas fa-mail-bulk"></i> Tujuan Surat</label>
                            <input type="text" class="form-control" name="tujuanSurat" placeholder="Tujuan Surat" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
...
<div class="modal fade" id="report">
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/reportSuratKeluar') ?>" method="POST">
                    <div class="form-group">
